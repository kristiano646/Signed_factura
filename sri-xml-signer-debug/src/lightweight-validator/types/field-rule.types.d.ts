...
export type ClassFieldDecorator<T = any> = (target: undefined, context: ClassFieldDecoratorContext<T>) => void;
...
export type RuleType = "string" | "number" | "boolean" | "object" | "array" | "enum";
