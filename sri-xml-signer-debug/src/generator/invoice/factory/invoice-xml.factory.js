...
export class InvoiceXmlFactory {
    create(invoice) {
        var _a;
        const { detalles, infoFactura, infoTributaria, infoAdicional, retenciones, } = invoice;
        const { ambiente, dirMatriz, estab, ptoEmi, razonSocial, ruc, secuencial, agenteRetencion, contribuyenteRimpe, nombreComercial, } = infoTributaria;
        const { dirEstablecimiento, identificacionComprador, importeTotal, pagos, propina, razonSocialComprador, tipoIdentificacionComprador, totalConImpuestos, totalDescuento, totalSinImpuestos, contribuyenteEspecial, direccionComprador, guiaRemision, moneda, obligadoContabilidad, fechaEmision, valorRetIva, valorRetRenta, } = infoFactura;
        ...
        const clave = p_obtener_codigo_autorizacion(fechaClave, documentTypeName[1], infoTributaria.ruc, infoTributaria.ambiente, Number(estab), Number(ptoEmi), infoTributaria.secuencial, null, Number(tipoEmision));
        ...
        const jsonFactura = {
            factura: {
                ...
                infoFactura: {
                    ...
                    identificacionComprador: tipoIdentificacionComprador ===
        ...
        const retencion = retenciones === null || retenciones === void 0 ? void 0 : retenciones.retencion;
        if (retencion) {
        ...
        // 1. Tomamos la lista (o único objeto) si existe
        const campoAdicional = infoAdicional === null || infoAdicional === void 0 ? void 0 : infoAdicional.campoAdicional;
        if (campoAdicional) {
        ...
        for (const detalle of detalles.detalle) {
            ...
            const detAdicionales = (_a = detalle.detallesAdicionales) === null || _a === void 0 ? void 0 : _a.detAdicional;
            if (detAdicionales) {
