...
import { ENV_ENUM, IDENTIFICATION_CODE_ENUM, OBLIGADO_CONTABILIDAD_ENUM, PAYMENT_METHOD_CODE_ENUM, TAX_CODE_ENUM, } from "../../../enums";
...
describe("InvoiceXmlFactory", () => {
    ...
    const baseInvoice = {
        ...
        infoFactura: {
            ...
            pagos: {
                pago: [
                    {
                        formaPago: PAYMENT_METHOD_CODE_ENUM.SIN_UTILIZACION_DEL_SISTEMA_FINANCIERO,
                        total: 112,
                        plazo: null,
                        unidadTiempo: null,
                    },
    ...
    it("should override identificacionComprador for CONSUMIDOR_FINAL", () => {
        ...
        expect(result.factura.infoFactura.identificacionComprador).toBe("9999999999999");
    });
        ...
        const invoice = {
            ...
            detalles: {
                detalle: [
                    {
                        ...getBaseInvoice().detalles.detalle[0],
                        detallesAdicionales: undefined, // simula que no viene
                    },
                ],
            },
        };
